...
Relato: *"os jogadores ainda estao roubando a bola por tras do jogador que esta
carregando a bola"*. Ver BallControl.rouboPorTras (config/player_behavior.js).
...
perdeu a bola. Sem esses dois cortes, os passes interceptados a 15 m entram na
conta e o numero nao quer dizer nada — foi o primeiro erro desta medicao.

A JANELA DE MEIO SEGUNDO nao e folgada por acaso: a posse passa SEMPRE por
"sem dono" durante um ou dois frames (o `ballCarrier` e apagado a cada toque de
conducao, ver match_loop.js), portanto exigir a troca no mesmo frame da-lhe zero
roubos em vinte minutos. Foi o segundo erro.

Uso: node tools/scratch/roubo_angulo.js [segundos]
*/
